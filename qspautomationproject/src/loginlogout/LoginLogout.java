...
//	public class LinkTextLocator {
		...
		public static void main(String[] args) throws InterruptedException  {
			...
			driver.findElement(By.id("signInSubmit")).click();			//Thread.sleep(10000);
